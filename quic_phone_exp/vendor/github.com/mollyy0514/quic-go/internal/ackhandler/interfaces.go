...
type SentPacketHandler interface {
	...
	ReceivedAck(dev string, f *wire.AckFrame, encLevel protocol.EncryptionLevel, rcvTime time.Time) (bool /* 1-RTT packet acked */, error)
	...
	OnLossDetectionTimeout(dev string) error
}
