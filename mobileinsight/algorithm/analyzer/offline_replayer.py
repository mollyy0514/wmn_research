...
from mobile_insight.monitor.monitor import Monitor, Event
        ...
        try:
            ...
            for file in log_list:
                ...
                while True:
                    ...
                    if decoded and i > 0 and i < df_len:
                        while datetime.now() - prev_time < logtime_df.iloc[i]['time_diff']:
                            continue
                        row = logtime_df.iloc[i]
                        curr_time = datetime.now()
                    i += 1
